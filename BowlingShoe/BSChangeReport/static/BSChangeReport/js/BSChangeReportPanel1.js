...
define(function (require) {
    var $ = require('jquery'),
        ...
        BSChangeReportPanel2 = require('/static/BSChangeReport/js/BSChangeReportPanel2.js');

    var exports = {};
    var timeOut;

    var $Panel1Form1 = $('#BSChangeReportPanel1Form1'),
        $Panel1Form1Submit = $('#BSChangeReportPanel1Form1Submit'),
        $Panel2Table1Id = $('#BSChangeReportPanel2Table1Id');
    ...
    function event() {
        ...
        $Panel1Form1.submit(function (e) {
            ...
            $.get('/BowlingShoe/BSChangeReport/panel1/form1/submit',data,function (res) {
                var status = res['status'],
                    msg = res['msg'];
                if (status === 1){
                    $Panel2Table1Id.bootstrapTable('destroy');
                    var columns = res['columns'];
                    BSChangeReportPanel2.Panel2Table1_init(
                        $start.val(), $end.val(),
