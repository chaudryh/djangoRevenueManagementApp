...
define(function (require) {
    ...
    function init() {
        require(['/static/BSChangeReport/js/BSChangeReportPanel1.js?version=' + global_version], function (BSChangeReportPanel1) {
            BSChangeReportPanel1.run()
        });
        require(['/static/BSChangeReport/js/BSChangeReportPanel2.js?version=' + global_version], function (BSChangeReportPanel2) {
            BSChangeReportPanel2.run()
        });
    }
