...
def index(request, *args, **kwargs):
    template_name = 'BSChangeReport/BSChangeReportIndex.html'
...
class Panel2:
    class Table1:
        ...
        def create(request, *args, **kwargs):
            ...
            products_id = ['108', '109', '110', '111', '112', '113', '114', '115',
                           '2010', '2011', '2020', '2030', '2040', '2041',
                           '2146481686', '2146532909', '2146507303', '2146481687',
                           '2146498449', '2146449490', '2146451733', '2146448891', '2146452976'
                           ]
            data, num = DataDAO.get_bs_change_report(
                                         start=start,
                                         end=end,
                                         eff_start=eff_start,
                                         eff_end=eff_end,
