...
define(function (require) {
    ...
    function init() {
        require(['/static/Bundle/js/BundlePanel1.js?version=' + global_version], function (BundlePanel1) {
            BundlePanel1.run()
        });
        require(['/static/Bundle/js/BundlePanel2.js?version=' + global_version], function (BundlePanel2) {
            BundlePanel2.run()
        });
    }
