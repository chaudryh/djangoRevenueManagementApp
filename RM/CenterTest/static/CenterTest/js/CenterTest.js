...
define(function (require) {
    ...
    function init() {
        require(['/static/CenterTest/js/CenterTestPanel1.js?version=' + global_version], function (CenterTestPanel1) {
            CenterTestPanel1.run()
        });
        require(['/static/CenterTest/js/CenterTestPanel2.js?version=' + global_version], function (CenterTestPanel2) {
            CenterTestPanel2.run()
        });
        require(['/static/CenterTest/js/CenterTestPanel3.js?version=' + global_version], function (CenterTestPanel3) {
            CenterTestPanel3.run()
        });
    }
