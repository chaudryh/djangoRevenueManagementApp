...
define(function (require) {
    ...
    function init() {
        require(['/static/Food/js/FoodPanel1.js?version=' + global_version], function (FoodPanel1) {
            FoodPanel1.run()
        });
        require(['/static/Food/js/FoodPanel2.js?version=' + global_version], function (FoodPanel2) {
            FoodPanel2.run()
        });
    }
