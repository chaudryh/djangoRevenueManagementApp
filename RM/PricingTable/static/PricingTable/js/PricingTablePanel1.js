...
define(function (require) {
    ...
    var $Panel1Table1ContainerId = $("#PricingTablePanel1Table1ContainerId"),
    ...
    function init() {
        $.get('/RM/PricingTable/panel2/form1/submit', function (res) {
    ...
    function event() {
            ...
            for (var i = 1; i < rowLength; i++) {
                if (row === table.rows[i].cells[0].innerHTML) {
                    ...
                    if(i === rowLength - 1) {
                        ...
                        mergeRows(saveIndex, 'bowling_tier', count);
        ...
        $Panel1Table1Id.on('editable-save.bs.table',function (editable, field, row, oldValue, $el) {
            ...
            $.get('/RM/PricingTable/panel1/table1/edit', row,function () {
    ...
    function Panel1Table1_init(start, end, columns) {
        ...
        $Panel1Table1Id.bootstrapTable({
            ...
            undefinedtext: '-',
            filter:true,
            url:"/RM/PricingTable/panel1/table1/create",
            ...
            if (this.options.showExport) {
                ...
                if (!$export.length) {
                    ...
                    $menu.find('li').click(function () {
                        ...
                        window.location.href = '/RM/PricingTable/panel1/table1/export/export.' + extension + '?' + $.param(table_params)
                    });
                }
            }
        };
