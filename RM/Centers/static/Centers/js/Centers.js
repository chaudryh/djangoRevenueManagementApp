...
define(function (require) {
    ...
    function init() {
        // require(['/static/Centers/js/CentersPanel1.js?version=' + global_version], function (CentersPanel1) {
        //     CentersPanel1.run()
        // });
        require(['/static/Centers/js/CentersPanel2.js?version=' + global_version], function (CentersPanel2) {
            CentersPanel2.run()
        });
    }
