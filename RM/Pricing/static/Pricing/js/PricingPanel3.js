...
define(function (require) {
    ...
    var $Panel3Table1ContainerId = $("#PricingPanel3Table1ContainerId"),
        $Panel3Table1Id = $("#PricingPanel3Table1Id");
    ...
    function init() {
        ...
        $Panel3Table1Id.bootstrapTable({
            ...
            undefinedText: '-',
            filter:true,
            url:"/RM/Pricing/panel3/table1/create",
            columns:[
                [
                    {
                        field: 'center_id',
    ...
    function event() {
        ...
        $Panel3Table1Id.on('editable-save.bs.table',function (editable, field, row, oldValue, $el) {
            ...
            $.get('/RM/Pricing/panel3/table1/edit', row,function () {
