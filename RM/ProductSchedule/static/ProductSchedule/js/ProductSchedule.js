...
define(function (require) {
    ...
    function init() {
        require(['/static/ProductSchedule/js/ProductSchedulePanel1.js?version=' + global_version], function (ProductSchedulePanel1) {
            ProductSchedulePanel1.run()
        });
        require(['/static/ProductSchedule/js/ProductSchedulePanel2.js?version=' + global_version], function (ProductSchedulePanel2) {
            ProductSchedulePanel2.run()
        });
    }
