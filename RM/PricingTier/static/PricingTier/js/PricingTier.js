...
define(function (require) {
    ...
    function init() {
        require(['/static/PricingTier/js/PricingTierPanel1.js?version=' + global_version], function (PricingTierPanel1) {
            PricingTierPanel1.run()
        });
        require(['/static/PricingTier/js/PricingTierPanel2.js?version=' + global_version], function (PricingTierPanel2) {
            PricingTierPanel2.run()
        });
    }
