...
define(function (require) {
    ...
    function init() {
        require(['/static/LeaguePricingSheet/js/LeaguePricingSheetPanel1.js?version=' + global_version], function (LeaguePricingSheetPanel1) {
            LeaguePricingSheetPanel1.run()
        });
        require(['/static/LeaguePricingSheet/js/LeaguePricingSheetPanel2.js?version=' + global_version], function (LeaguePricingSheetPanel2) {
            LeaguePricingSheetPanel2.run()
        });
    }
