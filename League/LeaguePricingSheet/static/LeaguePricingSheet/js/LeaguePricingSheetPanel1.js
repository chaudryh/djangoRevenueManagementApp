...
define(function (require) {
    var $ = require('jquery'),
        ...
        LeaguePricingSheetPanel2 = require('/static/LeaguePricingSheet/js/LeaguePricingSheetPanel2.js');

    var exports = {};
    var timeOut;

    var $Panel1Form1 = $('#LeaguePricingSheetPanel1Form1'),
        $Panel1Form1Submit = $('#LeaguePricingSheetPanel1Form1Submit'),
    ...
    function event() {
        ...
        $Panel1Form1.submit(function (e) {
            ...
            $.get('/League/LeaguePricingSheet/panel1/form1/submit',data,function (res) {
                var status = res['status'],
                    msg = res['msg'];
                if (status === 1){
                    $Panel2Table1Id.bootstrapTable('destroy');
                    var columns = res['columns'];
                    LeaguePricingSheetPanel2.Panel2Table1_init(
                        $duration.val(), columns
                    );
