...
define(function (require) {
    ...
    function init() {
        require(['/static/LeagueCenterInfo/js/LeagueCenterInfoPanel2.js?version=' + global_version], function (LeagueCenterInfoPanel2) {
            LeagueCenterInfoPanel2.run();
            require(['/static/LeagueCenterInfo/js/LeagueCenterInfoPanel1.js?version=' + global_version], function (LeagueCenterInfoPanel1) {
                LeagueCenterInfoPanel1.run()
            });
        });
    }
