...
define(function (require) {
    ...
    var $Panel2Table1ContainerId = $("#EventOverviewTestPanel2Table1ContainerId"),
    ...
    function init() {
        // $.get('/Event/EventOverviewTest/panel2/table1/submit', function (res) {
    ...
    function event() {
        ...
        $Panel2Table1Id.on('editable-save.bs.table',function (editable, field, row, oldValue, $el) {
            ...
            $.get('/Event/EventOverviewTest/panel2/table1/edit', row,function () {
    ...
    function Panel2Table1_init(sale_region, territory, columns) {
        ...
        $Panel2Table1Id.bootstrapTable({
            ...
            url:"/Event/EventOverviewTest/panel2/table1/create",
            queryParams: function (para) {
                para.sale_region = sale_region;
                para.territory = territory;
                return para
            },
            columns: columns,
