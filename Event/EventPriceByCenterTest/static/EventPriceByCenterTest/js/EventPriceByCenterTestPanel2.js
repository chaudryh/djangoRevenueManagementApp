...
define(function (require) {
    ...
    var $Panel2Table1ContainerId = $("#EventPriceByCenterTestPanel2Table1ContainerId"),
        $Panel2Table1Id = $("#EventPriceByCenterTestPanel2Table1Id");

    var $EventPriceByCenterTest_product = $("#product");
    ...
    function init() {
        $.get('/Event/EventPriceByCenterTest/panel1/form1/submit', function (res) {
    ...
    function event() {
        ...
        $Panel2Table1Id.on('editable-save.bs.table',function (editable, field, row, oldValue, $el) {
            ...
            $.get('/Event/EventPriceByCenterTest/panel2/table1/edit', row,function () {
    ...
    function Panel2Table1_init(columns) {
        ...
        $Panel2Table1Id.bootstrapTable({
            ...
            url:"/Event/EventPriceByCenterTest/panel2/table1/create",
