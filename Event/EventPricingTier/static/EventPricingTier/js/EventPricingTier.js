...
define(function (require) {
    ...
    function init() {
        require(['/static/EventPricingTier/js/EventPricingTierPanel1.js?version=' + global_version], function (EventPricingTierPanel1) {
            EventPricingTierPanel1.run()
        });
        require(['/static/EventPricingTier/js/EventPricingTierPanel2.js?version=' + global_version], function (EventPricingTierPanel2) {
            EventPricingTierPanel2.run()
        });
    }
