...
define(function (require) {
    ...
    var $Panel2Table1ContainerId = $("#EventPricingTierPanel2Table1ContainerId"),
    ...
    function init() {
        ...
        $.get('/Event/EventPricingTier/panel1/form1/submit', selections, function (res) {
    ...
    function event() {
        ...
        $Panel2Table1Id.on('editable-save.bs.table',function (editable, field, row, oldValue, $el) {
            ...
            row['subGroupSelect'] = $EventAllocationSubGroup.val();
            row['tierSelect'] = $EventAllocationTier.val();
            row['old_value'] = oldValue;

            $.get('/Event/EventPricingTier/panel2/table1/edit', row,function () {
    ...
    function Panel2Table1_init(columns) {
        ...
        $Panel2Table1Id.bootstrapTable({
            ...
            url:"/Event/EventPricingTier/panel2/table1/create",
