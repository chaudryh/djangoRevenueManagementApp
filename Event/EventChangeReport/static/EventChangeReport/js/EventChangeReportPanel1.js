...
define(function (require) {
    var $ = require('jquery'),
        ...
        EventChangeReportPanel2 = require('/static/EventChangeReport/js/EventChangeReportPanel2.js');

    var exports = {};
    var timeOut;

    var $Panel1Form1 = $('#EventChangeReportPanel1Form1'),
        $Panel1Form1Submit = $('#EventChangeReportPanel1Form1Submit'),
        $Panel2Table1Id = $('#EventChangeReportPanel2Table1Id');
    ...
    function event() {
        ...
        $Panel1Form1.submit(function (e) {
            ...
            $.get('/Event/EventChangeReport/panel1/form1/submit',data,function (res) {
                var status = res['status'],
                    msg = res['msg'];
                if (status === 1){
                    $Panel2Table1Id.bootstrapTable('destroy');
                    var columns = res['columns'];
                    EventChangeReportPanel2.Panel2Table1_init(
                        $start.val(), $end.val(),
