...
define(function (require) {
    ...
    function init() {
        require(['/static/EventChangeReport/js/EventChangeReportPanel1.js?version=' + global_version], function (EventChangeReportPanel1) {
            EventChangeReportPanel1.run()
        });
        require(['/static/EventChangeReport/js/EventChangeReportPanel2.js?version=' + global_version], function (EventChangeReportPanel2) {
            EventChangeReportPanel2.run()
        });
    }
