...
define(function (require) {
    ...
    var $Panel2Table1ContainerId = $("#EventAllocationPanel2Table1ContainerId"),
    ...
    function init() {
        ...
        $.get('/Event/EventAllocation/panel2/table1/get_columns', selections, function (res) {
    ...
    function event() {
        ...
        $Panel2Table1Id.on('editable-save.bs.table',function (editable, field, row, oldValue, $el) {
            row['field'] = field;
            row['group'] = $EventAllocationGroup.val();
            row['subGroup'] = $EventAllocationSubGroup.val();
            row['product'] = $EventAllocationProduct.val();
            row['old_value'] = oldValue;

            $.get('/Event/EventAllocation/panel2/table1/edit', row,function () {
    ...
    function Panel2Table1_init(columns) {
        ...
        $Panel2Table1Id.bootstrapTable({
            ...
            url:"/Event/EventAllocation/panel2/table1/create",
            queryParams: function (para) {
                para.group = $EventAllocationGroup.val();
                para.subGroup = $EventAllocationSubGroup.val();
                para.product = $EventAllocationProduct.val();
                para.tier = $EventAllocationTier.val();
                return para
            },
            columns: columns,
