...
define(function (require) {
    ...
    function init() {
        require(['/static/EventAllocation/js/EventAllocationPanel1.js?version=' + global_version], function (EventAllocationPanel1) {
            EventAllocationPanel1.run()
        });
        require(['/static/EventAllocation/js/EventAllocationPanel2.js?version=' + global_version], function (EventAllocationPanel2) {
            EventAllocationPanel2.run()
        });
    }
