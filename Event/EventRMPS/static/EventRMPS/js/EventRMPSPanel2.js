...
define(function (require) {
    ...
    var $Panel2Table1ContainerId = $("#EventRMPSPanel2Table1ContainerId"),
    ...
    function init() {
        // var selections = {
        //     'sale_region': $EventAllocationSaleRegion.val(),
        //     'territory': $EventAllocationTerritory.val(),
        //     'center_id': $EventAllocationCenterId.val(),
        //     'center_name': $EventAllocationCenterName.val(),
        //     'columns': $EventAllocationColumns.val(),
        // };
        //
        // $.get('/Event/EventRMPS/panel1/form1/submit', selections, function (res) {
    ...
    function event() {
        ...
        $Panel2Table1Id.on('editable-save.bs.table',function (editable, field, row, oldValue, $el) {
            ...
            $.get('/Event/EventRMPS/panel2/table1/edit', data, function (res) {
    ...
    function Panel2Table1_init(columns) {
        $Panel2Table1Id.bootstrapTable({
            ...
            url:"/Event/EventRMPS/panel2/table1/create",
