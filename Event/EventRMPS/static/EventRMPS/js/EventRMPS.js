...
define(function (require) {
    ...
    function init() {
        ...
        require(['/static/EventRMPS/js/EventRMPSPanel2.js?version=' + global_version], function (EventRMPSPanel2) {
            EventRMPSPanel2.run();
            require(['/static/EventRMPS/js/EventRMPSPanel1.js?version=' + global_version], function (EventRMPSPanel1) {
                EventRMPSPanel1.run()
            });
        });
    }
