...
define(function (require) {
    ...
    var EventRMPSTestPanel2 = require('/static/EventRMPSTest/js/EventRMPSTestPanel2.js?version=' + global_version);

    var exports = {};
    var timeOut;

    var $Panel1Form1 = $('#EventRMPSTestPanel1Form1'),
        $Panel1Form1Submit = $('#EventRMPSTestPanel1Form1Submit'),
    ...
    function event() {
        ...
        $Panel1Form1.submit(function (e) {
            ...
            $.get('/Event/EventRMPSTest/panel1/form1/submit',data,function (res) {
                var status = res['status'],
                    msg = res['msg'];
                if (status === 1){
                    $Panel2Table1Id.bootstrapTable('destroy');
                    var columns = res['columns'];
                    EventRMPSTestPanel2.Panel2Table1_init(columns);
    ...
    function refreshSelection (selectType) {
        ...
        if ($selectEl) {
            $selectEl.select2({
                ajax:{
                    url:'/Event/EventRMPSTest/panel1/form1/get_selections',
