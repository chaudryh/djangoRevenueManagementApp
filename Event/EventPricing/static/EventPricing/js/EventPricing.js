...
define(function (require) {
    ...
    function init() {
        require(['/static/EventPricing/js/EventPricingPanel1.js?version=' + global_version], function (EventPricingPanel1) {
            EventPricingPanel1.run()
        });
        require(['/static/EventPricing/js/EventPricingPanel2.js?version=' + global_version], function (EventPricingPanel2) {
            EventPricingPanel2.run()
        });
        require(['/static/EventPricing/js/EventPricingPanel3.js?version=' + global_version], function (EventPricingPanel3) {
            EventPricingPanel3.run()
        });
    }
