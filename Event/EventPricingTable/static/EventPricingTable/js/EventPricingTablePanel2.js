...
define(function (require) {
    var $ = require('jquery'),
        ...
        EventPricingTablePanel1 = require('/static/EventPricingTable/js/EventPricingTablePanel1.js');

    var $Panel2Form1 = $('#EventPricingTablePanel2Form1'),
        $Panel2Form1Submit = $('#EventPricingTablePanel2Form1Submit'),
    ...
    function run () {
        init();
        event();
        // EventPricingTablePanel1.Panel1Table1_init();
    }
    ...
    function event() {
        ...
        $Panel2Form1.submit(function (e) {
            ...
            $.get('/Event/EventPricingTable/panel2/form1/submit',data,function (res) {
                ...
                if (status === 1){
                    ...
                    EventPricingTablePanel1.Panel1Table1_init($start.val(), $end.val(), columns);
