...
define(function (require) {
    ...
    function init() {
        require(['/static/EventPricingTable/js/EventPricingTablePanel1.js?version=' + global_version], function (EventPricingTablePanel1) {
            EventPricingTablePanel1.run()
        });
        require(['/static/EventPricingTable/js/EventPricingTablePanel2.js?version=' + global_version], function (EventPricingTablePanel2) {
            EventPricingTablePanel2.run()
        });
    }
