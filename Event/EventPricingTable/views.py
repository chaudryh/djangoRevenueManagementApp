...
def index(request, *args, **kwargs):
    template_name = 'EventPricingTable/EventPricingTableIndex.html'
...
class Panel1:
    class Table1:
        ...
        def create(request, *args, **kwargs):
            ...
            data, num = GetEvent.get_event_price_table(start, end, product_list_new,
                                                       pagination=True,
                                                       page_size=page_size,
                                                       offset=offset,
                                                       filters=filters,
        ...
        def export(request, *args, **kwargs):
            ...
            if file_type == 'json':
                ...
                response['Content-Disposition'] = 'attachment; filename=tableExport.json'
            elif file_type == 'csv':
                response = data.to_csv(index=False)
                response = HttpResponse(response, content_type='application/csv')
                response['Content-Disposition'] = 'attachment; filename=tableExport.csv'
            elif file_type == 'xlsx':
                response = io()
                ...
                response['Content-Disposition'] = 'attachment; filename=tableExport.xlsx'
            # elif type == 'excel':
    ...
    class Form1:
        ...
        def submit(cls, request, *args, **kwargs):
            ...
            [
                ...
                {'field': 'bowling_event_tier', 'title': 'Bowling Tier'},
                ...
                [
                    {
                        ...
                        'align': 'center', 'vlign': 'center', 'width': 200
                    },
                    # {
