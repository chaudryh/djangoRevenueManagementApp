...
define(function (require) {
    ...
    function init() {
        // require(['/static/EventPromo/js/EventPromoPanel1.js?version=' + global_version], function (EventPromoPanel1) {
        //     EventPromoPanel1.run()
        // });
        require(['/static/EventPromo/js/EventPromoPanel2.js?version=' + global_version], function (EventPromoPanel2) {
            EventPromoPanel2.run()
        });
    }
