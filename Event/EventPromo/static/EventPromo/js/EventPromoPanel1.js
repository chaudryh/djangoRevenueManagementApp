...
define(function (require) {
    var $ = require('jquery'),
        ...
        EventPromoPanel2 = require('/static/EventPromo/js/EventPromoPanel2.js');

    var exports = {};
    var timeOut;

    var $Panel1Form1 = $('#EventPromoPanel1Form1'),
        $Panel1Form1Submit = $('#EventPromoPanel1Form1Submit'),
    ...
    function event() {
        ...
        $Panel1Form1.submit(function (e) {
            ...
            $.get('/Event/EventPromo/panel1/form1/submit',data,function (res) {
                var status = res['status'],
                    msg = res['msg'];
                if (status === 1){
                    $Panel2Table1Id.bootstrapTable('destroy');
                    var columns = res['columns'];
                    EventPromoPanel2.Panel2Table1_init(
                        $start.val(), $end.val(),
