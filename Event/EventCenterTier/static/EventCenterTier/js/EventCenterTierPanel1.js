...
define(function (require) {
    var $ = require('jquery'),
        ...
        EventCenterTierPanel2 = require('/static/EventCenterTier/js/EventCenterTierPanel2.js');

    var exports = {};
    var timeOut;

    var $Panel1Form1 = $('#EventCenterTierPanel1Form1'),
        $Panel1Form1Submit = $('#EventCenterTierPanel1Form1Submit'),
        $Panel2Table1Id = $('#EventCenterTierPanel2Table1Id');
    ...
    function event() {
        ...
        $Panel1Form1.submit(function (e) {
            ...
            $.get('/Event/EventCenterTier/panel1/form1/submit',data,function (res) {
                var status = res['status'],
                    msg = res['msg'];
                if (status === 1){
                    $Panel2Table1Id.bootstrapTable('destroy');
                    var columns = res['columns'];
                    EventCenterTierPanel2.Panel2Table1_init(
                        $start.val(), $end.val(),
