...
define(function (require) {
    ...
    var $Panel2Table1ContainerId = $("#EventCenterTierPanel2Table1ContainerId"),
    ...
    function init() {
        $.get('/Event/EventCenterTier/panel1/form1/submit', function (res) {
    ...
    function event() {
        ...
        $Panel2Table1Id.on('editable-save.bs.table',function (editable, field, row, oldValue, $el) {
            ...
            $.get('/Event/EventCenterTier/panel2/table1/edit', row,function () {
    ...
    function Panel2Table1_init(start, end, eff_start, eff_end, columns) {
        ...
        $Panel2Table1Id.bootstrapTable({
            ...
            url:"/Event/EventCenterTier/panel2/table1/create",
