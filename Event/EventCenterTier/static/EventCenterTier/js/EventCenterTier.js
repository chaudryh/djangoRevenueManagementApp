...
define(function (require) {
    ...
    function init() {
        // require(['/static/EventCenterTier/js/EventCenterTierPanel1.js?version=' + global_version], function (EventCenterTierPanel1) {
        //     EventCenterTierPanel1.run()
        // });
        require(['/static/EventCenterTier/js/EventCenterTierPanel2.js?version=' + global_version], function (EventCenterTierPanel2) {
            EventCenterTierPanel2.run()
        });
    }
