...
define(function (require) {
    ...
    function init() {
        // require(['/static/EventOverview/js/EventOverviewPanel1.js?version=' + global_version], function (EventOverviewPanel1) {
        //     EventOverviewPanel1.run()
        // });
        require(['/static/EventOverview/js/EventOverviewPanel2.js?version=' + global_version], function (EventOverviewPanel2) {
            EventOverviewPanel2.run()
        });
    }
