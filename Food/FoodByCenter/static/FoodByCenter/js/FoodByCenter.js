...
define(function (require) {
    ...
    function init() {
        ...
        require(['/static/FoodByCenter/js/FoodByCenterPanel2.js?version=' + global_version], function (FoodByCenterPanel2) {
            FoodByCenterPanel2.run();
            require(['/static/FoodByCenter/js/FoodByCenterPanel1.js?version=' + global_version], function (FoodByCenterPanel1) {
                FoodByCenterPanel1.run()
            });
        });
    }
