...
define(function (require) {
    var $ = require('jquery'),
        ...
        FoodChangeReportPanel2 = require('/static/FoodChangeReport/js/FoodChangeReportPanel2.js');

    var exports = {};
    var timeOut;

    var $Panel1Form1 = $('#FoodChangeReportPanel1Form1'),
        $Panel1Form1Submit = $('#FoodChangeReportPanel1Form1Submit'),
        $Panel2Table1Id = $('#FoodChangeReportPanel2Table1Id');
    ...
    function event() {
        ...
        $Panel1Form1.submit(function (e) {
            ...
            $.get('/Food/FoodChangeReport/panel1/form1/submit',data,function (res) {
                var status = res['status'],
                    msg = res['msg'];
                if (status === 1){
                    $Panel2Table1Id.bootstrapTable('destroy');
                    var columns = res['columns'];
                    FoodChangeReportPanel2.Panel2Table1_init(
                        $start.val(), $end.val(), null, null,
