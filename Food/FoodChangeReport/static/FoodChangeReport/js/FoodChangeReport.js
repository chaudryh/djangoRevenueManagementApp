...
define(function (require) {
    ...
    function init() {
        require(['/static/FoodChangeReport/js/FoodChangeReportPanel1.js?version=' + global_version], function (FoodChangeReportPanel1) {
            FoodChangeReportPanel1.run()
        });
        require(['/static/FoodChangeReport/js/FoodChangeReportPanel2.js?version=' + global_version], function (FoodChangeReportPanel2) {
            FoodChangeReportPanel2.run()
        });
    }
